...
Check out the [live demo](https://weird-name-generator.vercel.app) to see the generator in action. The demo source code is available in the `demo/` directory and showcases a full-featured React implementation using the generator and its hooks. For instructions on running the demo locally, see [README.md](./demo/README.md).
